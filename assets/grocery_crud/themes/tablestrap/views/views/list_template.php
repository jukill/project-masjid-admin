...
<div class="grocerycrud-container card panel-default">
	...
	<div class="">
		...
		<div class="card-body">
			...
			<?php if(!$unset_add){?>
				<!-- <a role="button" class="add_button btn btn-info hidden-xs" href="<?php echo $add_url?>"> -->
				<a role="button" class="add_button btn btn-info hidden-xs" href="<?php echo $add_url?>">
		...
		<!-- <div class="pull-right"> -->
			<div class="card-widgets text-white">
				...
				<?php if(!$unset_add){?>
					<a role="button" class="btn btn-primary waves-effect waves-light mb-2 mr-1" href="<?php echo $add_url?>" data-toggle="tooltip" title="Tambah <?= $subject?>">
                        <!-- <span class="glyphicon glyphicon-plus"></span> -->
                        <i class="fe-plus-square"></i>
						<span class="ui-button-text"><?php // echo $this->l('list_add'); ?> <?php //echo $subject?></span>
					</a>
